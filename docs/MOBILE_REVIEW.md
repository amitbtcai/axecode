# AxeCode Mobile — review, competitive comparison & roadmap

A review of the AxeCode mobile PWA (`src/mobile/`), how it stacks up against
...
coding agent." AxeCode already matches that shape and goes _further_ on some
axes (git/PR review, live browser mirroring, multi-desktop) while trailing on a
few table-stakes mobile niceties.

## Feature comparison

| Capability                                       | AxeCode (before)         | AxeCode (this branch)                            | Codex (ChatGPT) | Claude Code mobile |
| ------------------------------------------------ | ------------------------ | ------------------------------------------------ | --------------- | ------------------ |
...
input**. AxeCode has none — you must keep the app foregrounded. This is the
