  ...
  specs: [
    {
      name: "get_app_info",
      description:
        "Read-only overview of the running AxeCode app: version, platform, UI locale setting, project/thread counts, whether a desktop renderer window is connected (vs headless server), and this MCP server's name/version.",
