...
export const NON_ROUTER_PROJECT_PROCEDURES = {
  ...
  getContentCards: "device-owned-control",
  createContentCard: "remote-projects-excluded",
  updateContentCard: "remote-projects-excluded",
  deleteContentCard: "remote-projects-excluded",
