...
export const SETTINGS_SEARCH_INDEX: readonly SettingsSearchEntry[] = [
  // General
  {
    ...
    title: msg`Language`,
    description: msg`Choose the display language for Axe Code's interface.`,
  ...
  },
  {
    ...
    description: msg`When you close the window, keep Axe Code running in the system tray. Disable to quit on close.`,
  ...
  },
  {
    ...
    description: msg`Launch Axe Code automatically when you sign in to Windows.`,
  ...
  },
  {
    ...
    description: msg`Keep Axe Code in the system tray when it launches at startup.`,
  ...
  },
  {
    ...
    title: msg`Theme`,
    description: msg`Popular editor themes adapted to Axe Code. Each follows the light or dark mode above.`,
  ...
  },
  {
    ...
    description: msg`Used for agents, authentication, installs, and Axe Code's internal commands.`,
    keywords:
  ...
  },
  {
    ...
    description: msg`Worktree threads are marked done as soon as Axe Code sees their pull request merge. Threads mid-turn wait until the turn finishes.`,
  ...
  },
  {
    ...
    description: msg`Choose what Axe Code does for new pull requests: nothing, fix merge blockers, or fix and merge.`,
  ...
  },
  {
    ...
    description: msg`Choose how Axe Code performs manual merges and automatic PR merges.`,
  ...
  // Worktrees
  {
    ...
    description: msg`Use one global folder, or nest worktrees inside each project at .axecode/worktrees.`,
  ...
  // MCP Servers
  {
    ...
    description: msg`Manage the MCP server configurations Axe Code adds when starting supported agents. Workspace servers can be configured in each project's settings.`,
    keywords:
  ...
  // Browser
  {
    ...
    description: msg`Choose whether links from Axe Code and browser popups stay in Axe Code or open externally.`,
  ...
  },
  {
    ...
    description: msg`When links open in a Axe Code browser tab, choose where the browser is revealed.`,
