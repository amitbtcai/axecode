...
export function McpServersSettings() {
  ...
  return (
    <SettingsPage
      title={t`MCP Servers`}
      description={t`Manage the MCP server configurations Axe Code adds when starting supported agents. Workspace servers can be configured in each project's settings.`}
