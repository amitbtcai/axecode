...
export function WorktreeSettings() {
  ...
  return (
    <SettingsPage
      title={t`Worktrees`}
      description={t`Where Axe Code creates git worktrees for new branches. Changes apply to worktrees created from now on; existing worktrees stay where they are.`}
    >
      <SettingRow
        anchorId="worktrees.storageLocation"
        title={t`Storage location`}
        description={t`Use one global folder, or nest worktrees inside each project at .axecode/worktrees.`}
      >
        <Select
