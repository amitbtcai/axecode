...
export function RemoteServersSettings() {
  ...
  return (
    <SettingsPage
      ...
      description={t`Connect directly, through a relay, or over SSH. Every transport uses the same Axe Code remote protocol, projects, threads, and agent runtimes.`}
      ...
      {adding === "direct" ? (
        ...
        <div className="flex gap-2">
          <Button variant="tertiary" size="sm" onPress={() => setAdding("direct")}>
            ...
            <Trans>Pair with Axe Code</Trans>
          </Button>
