...
describe("AttachmentBar", () => {
  ...
  it("uses the owning remote machine URL for remote attachment previews", () => {
    ...
    render(
      <AttachmentBar
        attachments={[
          {
            id: "image-1",
            path: "/Users/host/.axecode/attachments/shot.png",
            name: "shot.png",
            mimeType: "image/png",
            isImage: true,
          },
    ...
    expect(screen.getByAltText("shot.png")).toHaveAttribute(
      "src",
      "https://mac.test/api/files/image?path=%2FUsers%2Fhost%2F.axecode%2Fattachments%2Fshot.png",
    );
    expect(imageUrlForPath).toHaveBeenCalledWith("/Users/host/.axecode/attachments/shot.png");
  });
    ...
    render(
      <AttachmentBar
        attachments={[
          {
            id: "image-1",
            path: "C:\\Users\\host\\.axecode\\attachments\\shot.png",
            name: "shot.png",
            mimeType: "image/png",
            isImage: true,
  ...
  it("renders flush attachment bars for inline message attachments", () => {
    ...
    expect(container.firstElementChild).toHaveClass("axecode-attachment-bar");
    expect(container.firstElementChild).not.toHaveClass("axecode-attachment-bar--inset");
  });
  ...
  it("renders the CSS selector instead of the file name on picked attachments", () => {
    ...
    expect(label).toHaveClass("axecode-attachment-chip__selector");
