...
export const metadata: Metadata = createPageMetadata({
  title: "AxeCode Support",
  description: "Get help pairing the AxeCode mobile companion or report a problem.",
  path: "/support",
});

const ISSUES_URL = "https://github.com/Porabuild/AxeCode/issues";
    ...
    <div className="relative min-h-screen overflow-x-hidden bg-black text-white">
      ...
      <main className="relative z-10 mx-auto max-w-3xl px-8 py-12">
        <header className="mb-12">
          <h1 className="text-3xl font-bold tracking-tight md:text-4xl">AxeCode Support</h1>
          <p className="mt-3 text-lg leading-8 text-gray-400">
            Help with pairing, connections, notifications, and the AxeCode mobile companion.
          </p>
        </header>
        ...
        <div className="space-y-10 text-[15px] leading-7 text-gray-300">
          <section>
            ...
            <ol className="list-decimal space-y-2 pl-5 marker:text-gray-500">
              <li>Open Settings → Remote Access in the AxeCode desktop app.</li>
          ...
          <section>
            ...
            <p>
              Include the AxeCode desktop and mobile versions, phone model, operating system,
