...
export const metadata: Metadata = createPageMetadata({
  title: "AxeCode Nightly — Latest pre-release builds",
  description:
    "Download the latest AxeCode nightly build. Pre-release installers with the newest changes, refreshed automatically from CI.",
  path: "/nightly",
});
